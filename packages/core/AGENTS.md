...
- Never add a new public symbol without updating `src/index.ts` — the barrel is the contract. Evidence: `src/index.ts:1-70` lists every exported symbol explicitly
